    ...
    >
      ...
      >
        <Typography fontWeight="xl" textColor="#fff">
          <BrushIcon className="bullets-style" />
        </Typography>
      ...
      <CardContent sx={{ gap: 1.5, minWidth: 200 }}>
        ...
        <CardContent>
          ...
          <Typography
            ...
            sx={{ mt: 0.5 }}
          >
            Our web design approach focuses on crafting user-centric and
            aesthetically pleasing websites that align with your brand identity
            and business goals.
          </Typography>
        </CardContent>
        {/* <Button
