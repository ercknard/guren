                ...
                >
                  ...
                  <CardContent>
                    <Typography className="sec-title" textColor="primary.200">
                      ...
                      <span className="text-effect">Aercrypt</span>
