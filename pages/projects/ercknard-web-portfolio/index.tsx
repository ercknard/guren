...
import GitWebPortfolio from "@/components/github/GitWebPorfolio";
...
export default class ErcknardWebPortfolio extends Component<Props, State> {
  ...
  render() {
    return (
      <>
        <Head>
          <title>Ercknard | Ercknard Web Portfolio</title>
        </Head>
        <Layout>
          <section>
            ...
            <div className="to-big">
              <div className="content-pages">
                  ...
                  <div className="to-flex to-align">
                    ...
                    <div className="to-proj-width">
                      ...
                      <div className="about-sub-text">
                        {" "}
                        Ercknard web portfolio is a digital exhibit of my
                      ...
                      >
                        ...
                        <Link
                          href="https://github.com/ercknard/guren"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          <div className="project-button">
                ...
                <TertiaryLayout>
                  <GithubLanguages projectName="Web Portfolio">
                    <GitWebPortfolio />
                  </GithubLanguages>
                </TertiaryLayout>
              </div>
