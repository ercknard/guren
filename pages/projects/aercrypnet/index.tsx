...
import GitAercrypt from "@/components/github/GitAercrypt";
          ...
          <section>
            ...
            <div className="to-big">
              <div className="content-pages">
                <div className="to-proj-aercrypt" />
                <div
                  data-aos="fade-up"
                  ...
                  <div className="to-flex to-align to-fix">
                    ...
                    <div className="to-proj-width">
                      ...
                      <div className="about-sub-text">
                        {" "}
                        The AerCrypt is a modifiable handheld crypto wallet that
                      ...
                      >
                        ...
                        <Link
                          href="https://github.com/Aerify-Digital/AerCrypt-site"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          <div className="project-button">
                ...
                <TertiaryLayout>
                  <GithubLanguages projectName="Aercrypt">
                    <GitAercrypt />
                  </GithubLanguages>
                </TertiaryLayout>
              </div>
