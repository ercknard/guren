...
import GitCryptechTest from "@/components/github/GitCryptechTest";
...
export default class ErcknardCryptechTest extends Component<Props, State> {
  state = {};
  ...
  render() {
    return (
      <>
        <Head>
          <title>Ercknard | CryptechTest</title>
        </Head>
        <Layout>
          <section>
              ...
              <div className="content-pages">
                ...
                <SecondaryLayout>
                  ...
                  <Breadcrumbs aria-label="breadcrumb" className="to-gray">
                    ...
                    <Typography className="to-white">CryptechTest</Typography>
                  </Breadcrumbs>
                  <div className="to-flex to-align">
                    ...
                    <div className="to-proj-width">
                      ...
                      <div className="about-sub-text">
                        {" "}
                        Join us and embark on a journey of creativity,
                        collaboration and adventure in our immersive world.
                      </div>
                      <div className="to-flex to-align">
                      ...
                      >
                        <Link
                          target="_blank"
                          href="https://cryptechtest.vercel.app/"
                        ...
                        <Link
                          href="https://github.com/ercknard/CryptechTest"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          <div className="project-button">
                ...
                <TertiaryLayout>
                  <GithubLanguages projectName="CryptechTest">
                    <GitCryptechTest />
                  </GithubLanguages>
                </TertiaryLayout>
              </div>
