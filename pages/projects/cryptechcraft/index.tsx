...
import GitCryptechCraft from "@/components/github/GitCryptechCraft";
              ...
              <div className="content-pages">
                ...
                <SecondaryLayout>
                  ...
                  <Breadcrumbs aria-label="breadcrumb" className="to-gray">
                    ...
                    <Typography className="to-white">CryptechCraft</Typography>
                  </Breadcrumbs>
                  <div className="to-flex to-align to-fix">
                    ...
                    <div className="to-proj-width">
                      ...
                      <div className="about-sub-text">
                        {" "}
                        CryptechCraft is a multi-server Minecraft network with
                        multiple game types and real cryptocurrency as in game
                        currency. CrystalCrypts, CryptoCredits, Guns,
                        ObsidianDestroyer and more custom plugins as well.
                      </div>
                      <div className="to-flex to-align to-fix">
                      ...
                      >
                        <Link
                          target="_blank"
                          href="https://obsidian-two.vercel.app/"
                        ...
                        <Link
                          href="https://github.com/ercknard/Obsidian"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          <div className="project-button">
                ...
                <TertiaryLayout>
                  <GithubLanguages projectName="CryptechCraft">
                    <GitCryptechCraft />
                  </GithubLanguages>
                </TertiaryLayout>
              </div>
